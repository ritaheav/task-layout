...
createElements = (petsList) => {
  ...
  for (let i = 0; i < petsList.length; i++) {
    str += `<div class="pet_card" id="pet_card">
...
document.querySelector('.back-double button').disabled = true;


const checkItemsPerPage = () => {
  if(document.querySelector('body').offsetWidth > 1279) {
    let petsSliderLength = 6;
    let currentPage = 1;
    document.querySelector('.page span').innerHTML = currentPage;
    document.querySelector('.back button').addEventListener('click', (e) => {
        if(currentPage === 2) {
            document.querySelector('.back button').disabled = true;
            document.querySelector('.next button').disabled = false; 
            document.querySelector('.next-double button').disabled = false; 
            document.querySelector('.back-double button').disabled = true;
        } 
            currentPage--;
            document.querySelector('.main_pets_wrap_slider').style.top = `calc(920px - ${920 * currentPage}px)`;
            document.querySelector('.page span').innerHTML = currentPage;
            document.querySelector('.next button').disabled = false; 
            document.querySelector('.next-double button').disabled = false;
    });
    ...
    document.querySelector('.next button').addEventListener('click', (e) => {
        if(currentPage === petsSliderLength - 1) {
            document.querySelector('.back button').disabled = false;
            document.querySelector('.next button').disabled = true;
            document.querySelector('.next-double button').disabled = true; 
            
        }
        currentPage++;
        document.querySelector('.back button').disabled = false;
        document.querySelector('.back-double button').disabled = false;
        document.querySelector('.main_pets_wrap_slider').style.top = `calc(920px - ${920 * currentPage}px)`;
        document.querySelector('.page span').innerHTML = currentPage;
    });
    
    document.querySelector('.back-double button').addEventListener('click', (e) => {
        currentPage = 1;
        document.querySelector('.back button').disabled = true;
        document.querySelector('.back-double button').disabled = true;
        document.querySelector('.next button').disabled = false; 
    ...
    document.querySelector('.next-double button').addEventListener('click', (e) => {
        currentPage = petsSliderLength;
        document.querySelector('.back button').disabled = false;
        document.querySelector('.back-double button').disabled = false;
        document.querySelector('.next button').disabled = true; 
        document.querySelector('.next-double button').disabled = true;
  ...
  if (document.querySelector('body').offsetWidth > 767 && document.querySelector('body').offsetWidth < 1280) {
    ...
    document.querySelector('.back button').addEventListener('click', (e) => {
        if(currentPage === 2) {
            ...
            currentPage--;
            document.querySelector('.main_pets_wrap_slider').style.top = `calc(1400px - ${1400 * currentPage}px)`;
            document.querySelector('.page span').innerHTML = currentPage;
            document.querySelector('.next button').disabled = false; 
            document.querySelector('.next-double button').disabled = false;
    });
  ...
  if (document.querySelector('body').offsetWidth < 768) {
    ...
    document.querySelector('.back button').addEventListener('click', (e) => {
        if(currentPage === 2) {
            ...
            currentPage--;
            document.querySelector('.main_pets_wrap_slider').style.top = `calc(1395px - ${1395 * currentPage}px)`;
            document.querySelector('.page span').innerHTML = currentPage;
            document.querySelector('.next button').disabled = false; 
            document.querySelector('.next-double button').disabled = false;
    });
...
function createPopup() {
  ...
  window.addEventListener('click', (e) => {
    ...
    [...document.querySelectorAll('.pet_card')].forEach(card => card.addEventListener('click', (event) => {
